...
let verboseIsDirty = (() => {
  ...
  return function verboseIsDirty(_x3) {
    return _ref3.apply(this, arguments);
  };
})();

let verboseRepository = (() => {
  var _ref4 = (0, _asyncToGenerator3.default)(function* (gitRepoDir) {
    console.log('Repository location by method:');
    console.log('  git rev-parse:', (yield _exec('git rev-parse --show-toplevel')));
    console.log('  find-up:      ', gitRepoDir);
  });

  return function verboseRepository(_x4) {
    ...
    return (0, _asyncToGenerator3.default)(function* () {
      ...
      switch (variable) {
        ...
        case 'isDirty':
          {
            ...
            DEBUG && (yield verboseIsDirty(changes));
        ...
        case 'repository':
          {
            const gitRepoDir = yield _this3._getGitRepoDir();
            DEBUG && (yield verboseRepository(gitRepoDir));
